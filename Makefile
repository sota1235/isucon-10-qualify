...
deploy: build
	...
	## MySQL
	rsync -av ./etc isucon10-qualify.app1:/home/isucon/ && ssh isucon10-qualify.app1 "sudo cp -v /home/isucon/etc/mysql/mysql.conf.d/mysqld.cnf /etc/mysql/mysql.conf.d/mysqld.cnf"
